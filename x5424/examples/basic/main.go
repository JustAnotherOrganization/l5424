...
func main() {
	l := x5424.New(l5424.InfoLvl.String(), nil, true)
	l.Log(x5424.Severity, l5424.DebugLvl, "And level filtering works (this should not display)\n")
	l.Log(x5424.Severity, l5424.InfoLvl, "Woo we have logging (no color)\n")
	l.Log(x5424.Severity, l5424.WarnLvl, "We have a warning color\n")
	l.Log(x5424.Severity, l5424.EmergencyLvl, "We have an error color\n")
